...
must be included to define the function prototype for `printf`:
...
The loader starts
with an undefined symbol, <code>_main</code>,
that is resolved by pulling in the run&#173;time startup code from the library.&#160;
(The loader undefines <code>_mainp</code> when profiling is enabled,
